...
<div id="home" class="overflow-hidden">
    <section class="relative">
        <div data-motion="scroll-parallax" data-motion-speed="0.12"
            class="pointer-events-none absolute -top-32 -right-24 -z-10 h-96 w-96 rounded-full bg-primary/10 blur-3xl">
        </div>
        <div data-motion="scroll-parallax" data-motion-speed="0.2" data-motion-axis="x"
            class="pointer-events-none absolute top-48 -left-24 -z-10 h-80 w-80 rounded-full bg-secondary/10 blur-3xl">
        </div>
        ...
        <div class="hero min-h-[88vh]">
            <div class="hero-content flex-col-reverse gap-12 max-w-6xl w-full py-16 lg:flex-row-reverse">
                <div class="w-full flex-1" data-motion="float-in">
                    <div class="mockup-window bg-base-300 border border-base-300 shadow-2xl">
                        <div class="space-y-4 bg-base-100 p-6">
                            <div class="flex items-center justify-between">
                                <div>
                                    <p class="text-sm opacity-60">Rekap Bulanan</p>
                                    <p class="text-lg font-bold">Mei 2026</p>
                                </div>
                ...
                <div class="w-full flex-1">
                    <span class="badge badge-soft badge-primary mb-5" data-motion="fade-up">
                    ...
                    <div data-motion="fade-up" data-motion-delay="0.55"
                        ...
                        <div>
                            <p class="text-2xl font-bold text-base-content">10rb+</p>
                            <p>data tercatat</p>
                        </div>
                        <div class="hidden h-8 w-px bg-base-300 sm:block"></div>
                        <div>
                            <p class="text-2xl font-bold text-base-content">500+</p>
                            <p>pengguna aktif</p>
                        </div>
                        <div class="hidden h-8 w-px bg-base-300 sm:block"></div>
                        <div>
                            <p class="text-2xl font-bold text-base-content">99,9%</p>
                            <p>akurasi rekap</p>
                        </div>
                    </div>
                </div>
    ...
    <section id="fitur" class="max-w-6xl mx-auto px-4 py-24">
        ...
        <div data-motion="stagger" class="mt-14 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            <div class="card bg-base-200 shadow-sm border border-base-300">
                <div class="card-body">
                    <div class="flex h-12 w-12 items-center justify-center rounded-xl bg-primary/10 text-2xl">📝</div>
    ...
    <section id="testimoni" class="max-w-6xl mx-auto px-4 py-24">
        ...
        <div class="mt-14 grid gap-6 md:grid-cols-3">
            <div data-motion="reveal" class="card bg-base-100 shadow-sm border border-base-300">
                <div class="card-body">
            ...
            <div data-motion="reveal" data-motion-delay="0.12"
            ...
            <div data-motion="reveal" data-motion-delay="0.24"
                class="card bg-base-100 shadow-sm border border-base-300">
                <div class="card-body">
    ...
    <section id="cta" class="max-w-6xl mx-auto px-4 pb-24">
        <div data-motion="blur-scale" class="card bg-primary text-primary-content rounded-3xl shadow-xl">
